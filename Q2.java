...
public class Q2 {
    public static void main(String[] arg) {
        ...
        // Take a count array ( size 21 as the array numbers are in range 0-20) to store
        // the count of each number in array arr
        int count[] = new int[21];

        // Take the numbers in array as input from user and parallely keep a count of
        // each number in count array
